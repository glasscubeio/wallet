...
router.post("/verify-email/request", requireAuth, auth.requestEmailVerification);
router.post(
...
router.post("/forgot-password", validate(z.object({ email })), auth.forgotPassword);
...
router.post("/delete-account/request", requireAuth, auth.requestAccountDeletion);
router.post(
